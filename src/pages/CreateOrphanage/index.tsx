...
import { Container, Content, CreateOrphanageForm, InputContent, ButtonAddImage, SelectedButtonContent, ConfirmButton, ImagesContainer } from './styles'
